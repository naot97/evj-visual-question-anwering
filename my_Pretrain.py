...
def train(model, general_loader, region_loader, mono_loader, text_loader, optimizer, epoch_info, device, scheduler, config, accelerator, checkpointer):
    ...
    print('general_loader', general_loader)
    print('mono_loader', mono_loader)
    print('text_loader', text_loader)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', default=2, type=int, help="for pre-training (debug) only")
