...
class ImageMonoTextDataset(ImageMultiTextDataset):
    def __init__(self, config, data_path, tokenizer, rank=0, world_size=1, shuffle=True, repeat=True, transform=None):
        super().__init__(config, data_path, shuffle=shuffle,
